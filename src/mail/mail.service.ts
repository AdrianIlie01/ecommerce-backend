  ...
  async generatePdf(createPdf: CreatePdfDto) {
    try {
      ...
      products.forEach((item) => {
        ...
        const componentValue = `${item.name}: ${item.count} buc`;
        ...
        if (startY + textHeight + 80 <= doc.page.height) {
          ...
          doc
            ...
            .font('RobotoLight')
            .fontSize(15)
            .text(item.count + ' buc', halfPage + 15, startY, {
      ...
      doc
        .font('RobotoBold')
        .fontSize(19)
        .text(`TotalCost:`, 50, startY + 140 - adjustY, {
          continued: true,
          align: 'left',
        });
      ...
      doc
        ...
        .fontSize(15)
        .text('Contact information', 50, startY + 615 - adjustY, {
          align: 'left',
          lineGap: 20,
        });
      ...
      doc
        .font('RobotoRegular')
        .fontSize(14)
        .text('Name:', 50, startY + 655 - adjustY, {
          continued: true,
          align: 'left',
        });
      ...
      doc
        .font('RobotoRegular')
        .fontSize(14)
        .text('Delivery address:', 50, startY + 675 - adjustY, {
          continued: true,
          align: 'left',
        });
      ...
      const addressValue = `Delivery address: ${address}`;
      ...
      doc
        .font('RobotoRegular')
        .fontSize(14)
        .text(`Phone number:`, 50, startY + 715 - adjustY + adjustYAddres, {
          continued: true,
          align: 'left',
        });
